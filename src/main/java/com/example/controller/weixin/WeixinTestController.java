...
public class WeixinTestController {
	...
	Logger logger = Logger.getLogger(WeixinTestController.class);
    ...
    public String getWeChartCode() throws Exception {
    	String url="https://open.weixin.qq.com/connect/oauth2/authorize?"
    			+"appid=wx563a0d7969cb0ae5"
    			+"&redirect_uri=http://yt6hi5.natappfree.cc/3upsi_delay/weixintest/callback"
    			+"&response_type=code"
    			+"&scope=snsapi_base"
...
//        request.getSession().setAttribute(Constants.OPENID_INFOS, openIdInfos);
        ...
        return "微信回调获参数【code："+code+" , state: " + state;
    }
